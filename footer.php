    ...
    <div class="container">
      <div class="footer-wrapper">
        ...
        <div class="footer__social-network">
          <h3 class="footer__title footer__title--inline">Sosial Network</h3>
        ...
        <div class="footer__contact-details">
          ...
          <ul class="footer__ul">
            ...
            <li class="footer__item footer__item-contact">
              <div class="footer__icon-wrapper">
                <img class="footer__icon" src="./img/phone-footer.svg" alt="Icon: Map">
              </div>
            ...
            <li class="footer__item footer__item-contact">
              <div class="footer__icon-wrapper">
                <img class="footer__icon" src="./img/email.svg" alt="Icon: Map">
              </div>
